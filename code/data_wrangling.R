...
#### import data####
EndalenOld<- read.csv("./data/veg/RAW_Excel/ENDALEN_ALLSITES_2003to2015.csv") #removes columns that are not relevant for my data analysis
str(EndalenOld)
names(EndalenOld)
...
fungr<- read.csv("./data/secondaryData/funcgroup2022_list.csv")
...
write_csv(plot_treatment, "../data/plot_treatment.csv")
...
Endalen2022wide<- read.csv("./data/secondaryData/data2022PerPlot.csv")
...
write.csv(allendalen_ordered,"/Users/ms/Documents/Uni/Masterarbeit/Data_Analysis_Endalen/data/secondaryData/allEndalenAbundance.csv", 
          row.names = FALSE)
